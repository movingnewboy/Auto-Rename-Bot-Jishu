...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "18141580")
    API_HASH  = os.environ.get("API_HASH", "701853e8fdb36fb8b6b1e978e1a45295")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8120431872:AAGhQEn73zKEguNF7N9MBnJ5TpjAykzmkHg") 
    ...
    FORCE_SUB   = os.environ.get("FORCE_SUB", "Tamilan_Rocks") 
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001547137091"))

    LOG_DATABASE = int(os.environ.get("LOG_DATABASE", "-1002354728574"))
    CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002262352503"))
